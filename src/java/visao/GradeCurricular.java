...
@WebServlet(name = "GradeCurricular", urlPatterns = {"/GradeCurricular"})
public class GradeCurricular extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<title>MATRIZ CURRICULAR</title>");
            out.println("</head>");
            out.println("<body>"
            ...
            for (int i = 0; i < disciplinas.size(); i++) {
                out.println("<tr class='dt'>"
                        + "<td>" + disciplinas.get(i).getPeriodo() + "</td>"
                        ...
                        + "<td>" + disciplinas.get(i).getTipo() + "</td>"
                        + "</tr>");
            }
            out.println(
                    "</table>"
            ...
            out.println("<form method = 'POST' action = 'addGrade' >"
                    + "<div class = 'sec'>"
                    ...
                    + " \n</section> </div>"
                    + "</form>");
            out.println("<form method='POST' action = 'upGrade'>"
                    + "<div class = 'sec'>"
